...
export default function InvoicesPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <h2 className="text-lg font-black text-slate-800 dark:text-white uppercase tracking-wider">Upload New Invoice</h2>
      ...
      >
        ...
        {status === "idle" && (
          <>
            ...
            <p className="text-xs font-bold text-slate-600 dark:text-slate-300">Drag or click to upload invoice</p>
        ...
        {status === "uploading" && (
          <>
            ...
            <p className="text-xs font-bold font-mono text-emerald-600 dark:text-emerald-400">Processing via AI Engine...</p>
          </>
        )}
        ...
        {status === "done" && (
          <>
            ...
            <p className="text-xs font-bold font-mono text-emerald-600 dark:text-emerald-400">Invoice Parsed Successfully</p>
          </>
        )}
      ...
      <div className="bg-slate-950 border border-slate-800 rounded-lg p-4 font-mono text-[11px] text-emerald-400 space-y-1 h-40 overflow-y-auto">
